                        ...
                        <?php foreach ($users as $user): ?>
                            <tr>
                                ...
                                <td>
                                    <ul>
                                        <li><button><a
                                                    href="<?= '/?page=modifier-utilisateur&id=' . $user['id_users'] ?>"><img
                                                        class="button-crud-users" src="assets/img/pen-writing-6.svg" />
                                                    Modifier</a></button></li>
                                        <li><button><a
                                                    href="<?= '/?page=supprimer-utilisateur&id=' . $user['id_users'] ?>"><img
                                                        class="button-crud-users" src="assets/img/trash.svg" />
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination justify-content-center">
                        ...
                        <li class="page-item first-page">
                            <a class="page-link" href="<?= '/?page=utilisateurs&pagination=1' ?>" aria-label="First">
                                <span aria-hidden="true">&laquo;</span>
                            </a>
                        </li>
                        <!-- Bouton pour revenir à la page précédente -->
                        <li class="page-item previous-page">
                            <a class="page-link" href="<?= '/?page=utilisateurs&pagination=' . ($currentPage - 1) ?>"
                                aria-label="Previous">
