  ...
  <div class="rigth-section-index">
    ...
    <div class="container-main-material">
      ...
      <div class="container-material">
        ...
        <div class="card-material">
          <div class="img-card-material"></div>
          <div>
            <h3>Catégories</h3><button>Voir <img src="assets/img/chevron-white.svg"></button>
          </div>
        </div>
        <div class="card-material">
          <div></div>
          <div>
            <h3>Marques</h3><button>Voir <img src="assets/img/chevron-white.svg"></button>
          </div>
        </div>
      </div>
      </div>
